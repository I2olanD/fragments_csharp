...
public struct ShellProfile : IFlatbufferObject
{
  ...
  public static Offset<ShellProfile> CreateShellProfile(FlatBufferBuilder builder,
  ...
  public static Offset<ShellProfile> EndShellProfile(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // indices
    return new Offset<ShellProfile>(o);
  }
}
