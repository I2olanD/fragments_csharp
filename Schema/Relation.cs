...
public struct Relation : IFlatbufferObject
{
  ...
  public static Offset<Relation> CreateRelation(FlatBufferBuilder builder,
  ...
  public static Offset<Relation> EndRelation(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // data
    return new Offset<Relation>(o);
  }
}
